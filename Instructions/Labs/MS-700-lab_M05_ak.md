...
9. Select the switch right from **Prevent toll bypass and send calls through the PSTN** to **On** and **Busy on busy is available when in a call** to **Enabled** and select **Save**.
